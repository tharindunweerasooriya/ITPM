...
public class NotAvailable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("No Available Time");
      ...
      public void tableloade(){
        ...
        try {
            ...
            String sql = "SELECT ID, startTime, endTime, lecturer, groupID, subGroup, sessionID, room FROM notAvailableTimes";
    ...
    private void add_roomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_roomActionPerformed
        // TODO add your handling code here:
        NotAvailableRoom ma = new NotAvailableRoom();
        ma.setVisible(true);
        this.dispose();
    ...
    private void ConsecutiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConsecutiveActionPerformed
        // TODO add your handling code here:
        ManageConsecutive ma = new ManageConsecutive();
        ma.setVisible(true);
        this.dispose();
