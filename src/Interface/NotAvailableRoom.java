...
public class NotAvailableRoom extends javax.swing.JFrame {
    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet res = null;

    /**
     * Creates new form NotAvailableRoom
     */
    public NotAvailableRoom() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Not Available Time Room");
        ...
        btn_con.setText("Manage Not Available");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup()
                    .addGap(97, 1091, Short.MAX_VALUE)
    ...
    //String roomT1 = Room_Type;
        ...
        try {
            String sql = "UPDATE `notAvailableTimes` SET `room`='"+j2+"' WHERE ID = '"+j1+"'";
    ...
    private void btn_conActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_conActionPerformed
        // TODO add your handling code here:
        NotAvailable ms = new NotAvailable();
        ms.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotAvailableRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotAvailableRoom().setVisible(true);
            }
        });
    }
